...
import service.transpiler.compose.button.*;
import service.transpiler.compose.image.*;
import service.transpiler.compose.layout.*;
import service.transpiler.compose.table.*;
import service.transpiler.compose.text.*;
import service.transpiler.compose.view.*;
import utils.Log;

import java.util.HashMap;
import java.util.Map;

public class CUITranspilerRegistry {
