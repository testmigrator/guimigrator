...
public class ButtonTranspiler extends SUIInitTranspiler {
    ...
    public TargetView.Property translateDefaultBrackets(Map<String, String> attributes, String defaultValue) {
