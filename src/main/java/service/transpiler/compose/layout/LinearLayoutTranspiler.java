...
@ViewType(values = {"LinearLayout"})
public class LinearLayoutTranspiler extends CUIInitTranspiler {
    ...
    protected void fillTargetViewName(ViewElement viewElement) {
        ...
        this.targetName = "vertical".equals(orientation) ? "Column" : "Row";
    }
    ...
    protected void fillSourcePropertyKeyList() {
        ...
        sourcePropertyKeyList.add(SourcePropertyKeyEnum.android__orientation);
    }
