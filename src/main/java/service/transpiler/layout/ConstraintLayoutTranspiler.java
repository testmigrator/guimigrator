package service.transpiler.layout;
...
import service.transpiler.UITranspilerRegistry;
...
public class ConstraintLayoutTranspiler extends UIInitTranspiler {
    ...
    public TargetView translate(ViewElement viewElement) {
        ...
        for (ViewElement child : viewElementChildren) {
            ...
            if (rearrangement != null) {
                ...
                UITranspiler ct = UITranspilerRegistry.createTranslator(targetViewElement.getType());
                if (ct != null) {
