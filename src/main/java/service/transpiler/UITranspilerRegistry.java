...
import service.transpiler.button.*;
import service.transpiler.image.ImageViewTranspiler;
import service.transpiler.layout.*;
import service.transpiler.table.TableRowTranspiler;
import service.transpiler.text.EditTextTranspiler;
import service.transpiler.text.TextViewTranspiler;
import service.transpiler.view.*;
import utils.Log;

import java.util.HashMap;
import java.util.Map;

public class UITranspilerRegistry {
