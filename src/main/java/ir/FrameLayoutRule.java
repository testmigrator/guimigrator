...
public final class FrameLayoutRule implements NodeRule {

    @Override
    public boolean supports(ViewElement e) {
        String t = e.getType();
        if (t == null) return false;
        return t.endsWith("FrameLayout") || "FrameLayout".equals(t);
    }

    @Override
    public NodeSpec apply(NodeContext ctx, ViewElement e) {
        return NodeSpec.builder()
                .kind(UIKind.FRAME_CONTAINER)
                .layoutSpec(FrameLayoutSpec.builder().build())
