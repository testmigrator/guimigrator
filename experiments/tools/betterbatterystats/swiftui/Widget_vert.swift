...
struct Widget_vert: View {
  var body: some View {
    ZStack {
      VStack(alignment: .leading, spacing: 0) {
        ZStack {
          Image(systemName: "photo").resizable().scaledToFit().frame(maxWidth: .infinity)
          Image("ic_action_refresh").resizable().scaledToFit().frame(width: 16.0, height: 16.0).frame(maxWidth: .infinity, maxHeight: .infinity, alignment: .topTrailing)
        }
...
struct Widget_vert_Previews: PreviewProvider {
