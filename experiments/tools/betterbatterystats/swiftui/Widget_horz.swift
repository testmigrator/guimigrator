...
struct Widget_horz: View {
  var body: some View {
    ZStack {
      ZStack {
        Image(systemName: "photo").resizable().scaledToFit().frame(maxHeight: .infinity).frame(maxWidth: .infinity)
        Group {
...
struct Widget_horz_Previews: PreviewProvider {
