  ...
  var body: some View {
    VStack(alignment: .leading, spacing: 0) {
      ...
      HStack(alignment: .center, spacing: 0) {
        ...
        .frame(width: 4.0)
        VStack(alignment: .leading, spacing: 0) {
          Text("USPS Express Mail").font(.system(size: 15)).foregroundColor(Color(red: 0.12941176470588237, green: 0.12941176470588237, blue: 0.12941176470588237, opacity: 1)).frame(maxWidth: .infinity, alignment: .leading)
        ...
        Spacer()
        .frame(width: 8.0)
        Image("branch_detail").background(Color.clear).padding(10.0)
      }
      .frame(maxWidth: .infinity)
    }
    .frame(maxWidth: .infinity)
